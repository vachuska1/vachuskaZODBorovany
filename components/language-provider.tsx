...
const translations = {
  cs: {
    ...
    news: "Aktuality",
    vos: "VOS",
    vosTitle: "VOS - Interní oznamovací systém",
    documents: "Dokumenty",
    contact: "Kontakt",
    navigation: "Navigace",
    gallery: "Fotogalerie",
    ...
    week1: "Tento týden",
    week2: "Příští týden",
    thisWeek: "Jídelní lístek 1",
    nextWeek: "Jídelní lístek 2",
    print: "Tisk",
    ...
    kitchenManager: "Závodní kuchyně",
  ...
  en: {
    ...
    news: "News",
    vos: "IRS",
    vosTitle: "IRS - Internal Reporting System",
    documents: "Documents",
    contact: "Contact",
    ...
    kitchenManager: "Company canteen",
  ...
  de: {
    ...
    news: "Neuigkeiten",
    vos: "IM",
    vosTitle: "IM - Internes Meldesystem",
    documents: "Dokumente",
    contact: "Kontakt",
    navigation: "Navigation",
    gallery: "Galerie",
    ...
    week1: "Diese Woche",
    week2: "Nächste Woche",
    thisWeek: "Speisekarte 1",
    nextWeek: "Speisekarte 2",
    print: "Drucken",
    whatWeDo: "WAS WIR MACHEN",
    farmAreas: "Bauernhofgelände",
    idNumber: "ID",
    vatId: "USt-ID-Nr.",
    ...
    kitchenManager: "Betriebskantine",
